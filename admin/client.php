...
<section class="messages-section" id="messages-section">
    ...
    <?php } ?>
      ...
      <div class="table-data">
              ...
              <td><?php echo $utilisateur['nom']?> <?php echo $utilisateur['prenom']?></td>
              <td><?php echo $utilisateur['email']?></td>
              <td><?php echo $utilisateur['adress']?></td>
                            ...
                            <td>
    <a href="delete_client.php?id=<?php echo $utilisateur['id']; ?>" onclick="return confirm('Are you sure you want to delete this client?');">
        <button class="btn2" style="background-color: red;">
